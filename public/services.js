...
//         .factory('WebcamCapture', ['$resource', function($resource){
//             var webcam = {};

//                 var sendSnapchot = sendSnapchot function(image){
//                     $resource(url, paramDefaults, actions)
//                 }

//                 webcam.takeSnapchot = function(){
...
(function (){
    ...
    function CheckinService($resource){
        ...
        // }
        // //check in or ckeck out 
        // //will write data in reporting schema in db
        // checkin.code = function(code){
        //     //return $resource
        // }
    ...
    function ChecklistService($resource, baseURL){
       ...
       return $resource("/api/checklist/checklist");
    } 
