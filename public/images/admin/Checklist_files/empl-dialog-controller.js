...
angular.module('checklist')
  .controller('EmployeeDialogCtrl', ['$http','$state','$mdDialog','$mdToast', 'EmployeesService', 'dpts','botIds',
    function ($http, $state, $mdDialog, $mdToast, EmployeesService, dpts, botIds) {
      var vm = this;
      console.log(dpts);
      console.log(botIds);
