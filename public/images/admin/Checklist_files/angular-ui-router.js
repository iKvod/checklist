 ...
 * * `'/files/*path'` - ditto.
 * * `'/callendar/{start:date}'` - Matches "/callendar/2014-11-12" (because the pattern defined
 ...
 *
 * @param {string=} name A view name. The name should be unique amongst the other components in the
 * same state. You can have components of the same name that live in different states.
 *
 ...
 * </pre>
 *
 * The above is a convenient shortcut equivalent to specifying your view explicitly with the {@link ui.router.state.$stateProvider#methods_state `components`}
 ...
 * </pre>
 *
 * But typically you'll only use the components property if you name your view or have more than one view
 ...
 * </pre>
 *
 * Really though, you'll use components to set up multiple components:
 * <pre>
 * <div ui-view></div>
